...
return array (
    ...
    '<em>Everyone</em> should do this. And I don’t just mean informally: this should really be a universal rule of serious software development. Not just product code - everything. it’s not that much work, and it makes a huge difference.',
    ...
    'The thing is, this is <em>such</em> a thoroughly natural mistake to make. If you’re a programmer, when you look at a problem, you can <em>see</em> a solution - and you think of what you’ve seen as <em>the</em> solution. But it isn’t - and to be a good reviewer, you need to get that.',

    'The second major pitfall of review is that people feel obligated to say <em>something</em>. You know that the author spent a lot of time and effort working on the code - shouldn’t you say <em>something</em>?',
